...
const AdminSidebar = () => {
  ...
  const isActive = (path) => location.pathname === path || (location.pathname.startsWith(path) && path !== '/admin');
  ...
  return (
    <div className="w-72 bg-[#1a202c] min-h-screen text-white flex flex-col shadow-xl z-30 transition-all duration-300">
      <div className="p-8 pb-4 flex items-center gap-3">
        <div className="w-10 h-10 bg-[#4B9B6E] rounded-lg flex items-center justify-center transform rotate-3 shadow-lg">
      ...
      <div className="mx-6 mb-6 mt-2 pt-6 border-t border-gray-700/50">
        <p className="text-xs uppercase tracking-wider text-gray-500 font-semibold mb-4">Main Menu</p>
                ...
                <li key={item.path}>
                  <Link
                    ...
                    className={`flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 group ${active
                      ? 'bg-[#4B9B6E] text-white shadow-md shadow-green-900/20 translate-x-1'
      ...
      <div className="mt-auto mx-6 mb-6 pt-6 border-t border-gray-700/50">
        <button
          onClick={handleLogout}
          className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-red-600 to-red-700 hover:from-red-500 hover:to-red-600 text-white px-4 py-3 rounded-xl transition-all shadow-md shadow-red-900/20 group"
        >
